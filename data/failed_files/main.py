...
class AuditVideo:
    ...
    def fit(self):
        try:
            if not self.file_name.endswith("png"):
                ...
                ready, not_ready = ray.wait([audio_future, video_future, quality_future, watermark_future,video_nudity_future], num_returns=5)
                ...
                ray.internal.free([audio_future, video_future, quality_future, watermark_future,video_nudity_future])
    ...
    def build_table_of_contents(self, emotion, hate_speech, video_details,nudity_details):
        content_header = list()
        content_item = dict()
    ...
    def populate_quality_details(
        ...
        self.quality_details["TABLE_OF_CONTENTS"] = self.build_table_of_contents(emotion, hate_speech, video_details.copy(),nudity_details.copy())
